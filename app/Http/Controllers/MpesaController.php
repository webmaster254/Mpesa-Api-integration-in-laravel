...
class MpesaController extends Controller
{
    ...
    public function customerMpesaSTKPush()
    {
        ...
        $curl_post_data = [
            ...
            'CallBackURL' => 'https://jmacaharia.co.ke/',
            'AccountReference' => "Webtech Developer",
    ...
    public function generateAccessToken(){
        ...
        $consumer_key="nY3yXIvuDTu8TQbnFAPdFK0LHT4sJVry";
        $consumer_secret="OkSBghrAzjDCL2r0";
    ...
    //j-son response to Mpesa Api feedback -success or failure
    ...
    public function mpesaRegisterUrls()
    {
        ...
        curl_setopt($curl, CURLOPT_POSTFIELDS, json_encode(array(
            ...
            'ConfirmationURL' => "https://jmacharia.co.ke/api/v1/hlab/transaction/confirmation",
            'ValidationURL' => "https://jmacharia.co.ke/api/v1/hlab/validation"
        )));
        $curl_response = curl_exec($curl);
        echo $curl_response;
    }
